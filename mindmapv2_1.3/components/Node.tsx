...
const Node: React.FC<NodeProps> = (props) => {
  ...
  const handleTextClick = (e: React.MouseEvent) => {
    ...
    if (e.detail === 1) {
        ...
        // If a second click arrives, clear the single-click timer.
        ...
        // If a third click arrives, clear the timer and trigger the text menu.
        if (singleClickTimerRef.current) {
            clearTimeout(singleClickTimerRef.current);
            singleClickTimerRef.current = null;
        }
        ...
        {isEditing ? (
          <>
            ...
            <textarea 
                ...
                className={`w-full bg-transparent text-slate-800 dark:text-slate-100 font-medium focus:outline-none resize-none overflow-hidden break-words ${image ? 'text-center' : 'text-left'}`}
                style={{
