...
const MindMap = forwardRef<MindMapActions, MindMapProps>((props, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    ...
    zoomToFit: () => {
        ...
        // Fix for "Expected 1 arguments, but got 0": The parser might be confused by an inline empty object.
        const bboxOptions = {};
        const gBounds = gElement.getBBox(bboxOptions);
          ...
          longPressTimerRef.current = setTimeout(() => {
            if (isAwaitingLongPressRef.current) { // Check if not cancelled by movement
              ...
              if (typeof navigator.vibrate === 'function') {
                ...
                // Fix for "Expected 1 arguments, but got 0": The parser might be confused by an inline literal.
              ...
              // Fix for "Expected 1 arguments, but got 0": The parser might be confused by an inline array literal.
              const pointToInvert = [touchStartPosRef.current.x, touchStartPosRef.current.y];
