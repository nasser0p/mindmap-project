      ...
      {isOpen && (
        ...
        >
          ...
          >
            <button
              onClick={onClose}
              className="absolute top-3 right-3 w-8 h-8 rounded-full flex items-center justify-center text-slate-500 hover:bg-slate-100/50 dark:hover:bg-slate-700/50"
            >
            ...
            <div className="flex flex-col gap-4">
              <button
                ...
                className="w-full p-6 bg-slate-100/50 dark:bg-slate-700/50 rounded-lg text-left hover:bg-slate-200/50 dark:hover:bg-slate-600/50 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-lg bg-blue-100/80 dark:bg-blue-900/50 flex items-center justify-center text-xl text-blue-500">
              ...
              >
                 <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-lg bg-purple-100/80 dark:bg-purple-900/50 flex items-center justify-center text-xl text-purple-500">
