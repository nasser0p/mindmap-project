...
const MindMap = forwardRef<MindMapActions, MindMapProps>((props, ref) => {
        ...
        if (isTouchEvent) {
          ...
          longPressTimerRef.current = setTimeout(() => {
            if (isAwaitingLongPressRef.current) { // Check if not cancelled by movement
              ...
              // Fix: Explicitly type the point to help TypeScript's inference with d3-zoom.
  ...
  }, [nodes, d3Root, onNodeSelect, onNodeDragStart, onMultipleNodePositionsUpdate, onNodeMove, isDescendant, focusedNodeId, root, isReviewModeActive, getAllDescendantIds, handleNodeSelect, onNodeDoubleClickEdit]);
