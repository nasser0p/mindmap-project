...
const Toolbar: React.FC<ToolbarProps> = (props) => {
    ...
    return (
        <div className="absolute top-6 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-2">
            <motion.div
                layout
                className="relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-md rounded-xl shadow-lg p-1 flex items-center gap-1 border border-slate-200/80 dark:border-slate-700/80"
                initial={{ width: 'auto' }}
