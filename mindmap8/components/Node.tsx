...
const Node: React.FC<NodeProps> = (props) => {
  ...
  // Calculate background color. Returns undefined if score is 0, letting Tailwind classes apply.
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        touchAction: 'none',
        borderStyle: 'solid',
        // Set initial background color if it exists. This avoids a flash on initial render.
