...
const ChapterSidebar: React.FC<ChapterSidebarProps> = (props) => {
    ...
    return (
        <div className="flex-shrink-0 bg-slate-100/80 dark:bg-slate-900/50 backdrop-blur-sm border-b border-slate-200 dark:border-slate-700">
            <div
            ...
            >
                ...
                {isAdding ? (
                    ...
                    <button
                        ...
                        className="w-10 h-10 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-800 rounded-full transition-colors flex-shrink-0"
