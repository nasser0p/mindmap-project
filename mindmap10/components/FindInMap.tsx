...
const FindInMap: React.FC<FindInMapProps> = ({
  ...
  return (
    <motion.div
      ...
      className="w-[550px] flex flex-col items-stretch gap-2 p-2 bg-white/80 dark:bg-slate-800/80 backdrop-blur-md rounded-xl shadow-lg border border-slate-200/80 dark:border-slate-700/80"
    >
        ...
        <div className="flex items-center justify-between gap-2 border-t border-slate-200/80 dark:border-slate-700/80 pt-2 text-sm">
