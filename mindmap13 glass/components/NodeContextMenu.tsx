...
interface NodeContextMenuProps {
    ...
    // FIX: Renamed prop to onSetColor for consistency with other components.
...
const NodeContextMenu: React.FC<NodeContextMenuProps> = (props) => {
    const {
        ...
        onExtractConcepts, onGenerateAnalogy, onIdentifyAndLabel, onSetColor, onFocusNode, onTestBranch,
