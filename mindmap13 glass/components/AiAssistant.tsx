...
const AiAssistant: React.FC<AiAssistantProps> = (props) => {
    ...
    if (!isOpen) {
        return (
             <motion.button
                onClick={onOpen}
                className="fixed bottom-6 right-6 lg:bottom-auto lg:top-1/2 lg:-translate-y-1/2 lg:right-0 z-20 w-16 h-16 bg-slate-300/20 dark:bg-slate-900/40 text-white dark:text-slate-200 backdrop-blur-lg rounded-full flex items-center justify-center shadow-lg hover:bg-slate-300/40 dark:hover:bg-slate-900/60 border border-white/20 dark:border-slate-100/10 transition-all duration-300 transform hover:scale-110 lg:rounded-r-none lg:w-12 lg:h-24"
