...
const MobileToolbar: React.FC<MobileToolbarProps> = (props) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-20">
      ...
      <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-md shadow-[0_-5px_15px_-5px_rgba(0,0,0,0.1)] p-1.5 border-t border-white/20 dark:border-slate-700/50">
